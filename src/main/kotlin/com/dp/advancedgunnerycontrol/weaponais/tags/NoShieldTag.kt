...
class NoShieldTag(weapon: WeaponAPI) : WeaponAITagBase(weapon) {
    override fun isValidTarget(entity: CombatEntityAPI): Boolean {
        if (!super.isValidTarget(entity)) return false
        val targetShip = entity as? ShipAPI ?: return true
        return targetShip.shield == null || targetShip.shield?.isOff == true
    }
