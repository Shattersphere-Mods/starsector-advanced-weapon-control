...
class ConservePDAmmoTag(weapon: WeaponAPI, private val ammoThresholdOverride: Float? = null) : WeaponAITagBase(weapon) {
    private fun ammoThreshold(): Float = ammoThresholdOverride ?: Settings.conservePDAmmo()
    ...
    override fun isValid(): Boolean = super.isValid() && weapon.usesAmmo() && weapon.type != WeaponAPI.WeaponType.MISSILE
}
