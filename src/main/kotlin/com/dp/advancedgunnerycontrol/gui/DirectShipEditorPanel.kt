...
import com.dp.advancedgunnerycontrol.gui.suggesttaggui.SuggestedTagGuiView
import com.dp.advancedgunnerycontrol.gui.suggesttaggui.SuggestedConfirmationModalIds
import com.dp.advancedgunnerycontrol.gui.suggesttaggui.SuggestedTagEditorState
import com.dp.advancedgunnerycontrol.gui.suggesttaggui.SuggestedTagUiAction
import com.dp.advancedgunnerycontrol.gui.suggesttaggui.renderSuggestedConfirmationModal as renderSuggestedConfirmationModalShared
...
class DirectShipEditorPanel(
    ...
    companion object {
        ...
        fun openOnCurrentScreen(ship: ShipAPI, closeHotkey: Int, onClosed: () -> Unit): DirectShipEditorPanel? {
            ...
            val screenPanel = com.dp.advancedgunnerycontrol.utils.invokeMethodByName(
                "getScreenPanel",
                state,
    ...
    private val tagView = com.dp.advancedgunnerycontrol.typesandvalues.TagListView()
    ...
    private fun processSuggestedTagsInput(events: MutableList<InputEventAPI>) {
        ...
        if (suggestedActionButtons.processCampaignButtonRightClickInput(events)) return
    ...
    private fun bindSuggestedActionButton(
        ...
        val control = suggestedActionButtons.addCampaignButtonControl(
            button = button,
    ...
    private fun renderSuggestedConfirmationModal(panel: CustomPanelAPI) {
        ...
        val modal = renderSuggestedConfirmationModalShared(
            ...
            suggestedActionButtons.addRenderedConfirmationModalButtons(
                modal = modal,
                onConfirm = {
                    request.onConfirm()
                    requestRebuild()
    ...
    private fun closeSuggestedConfirmationModalTargeted() {
        ...
        try {
            ...
            suggestedActionButtons.clearRenderedConfirmationModalButtons(
